...
<body>
    ...
    <hr/>
    <span>你的位置：</span>
    <a href=""><span>Banner管理</span></a>
    <span>></span>
    <span>添加Banner</span>
	<section>
        <span style="margin:20px 0;display: block;">商品预览图：</span>
        <form action="<?php echo U('Banner/insert');?>" method="post" enctype="multipart/form-data"> 
	        <!-- 加载编辑器的容器 -->
	        <script id="container" name="banner" type="text/plain"></script>
	        <!-- 配置文件 -->
